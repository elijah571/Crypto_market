...
const Coin = () => {
  ...
  const fetchCoinData = async () => {
    const options = {
      ...
      headers: {
        ...
        'x-cg-demo-api-key': 'CG-rox3UHx6WsmJ6gsbNkU6W94G',
      },
    };
  ...
  const fetchHistoricalData = async () => {
    const options = {
      method: 'GET',
      headers: { accept: 'application/json', 'x-cg-demo-api-key': 'CG-rox3UHx6WsmJ6gsbNkU6W94G' }
    };
  ...
  useEffect(() => {
    fetchCoinData();
    fetchHistoricalData();  // Invoke the function here
  }, [currency]);
